...
function ListTrashStaff() {
    ...
    useEffect(() => {
        apiStaff.getListTrash().then((res) => {
            setListTrash(res);
    ...
    function rescoverTrash(id) {
        apiStaff.rescoverTrash(id).then(function (result) {
    ...
    const delMember = async (id) => {
        apiStaff.delStaffById(id).then((res) => {
            try {
